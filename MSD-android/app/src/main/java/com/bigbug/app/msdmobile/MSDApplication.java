...
public class MSDApplication extends Application {
    ...
    public static final String TAG = MSDApplication.class.getSimpleName();

    private RequestQueue mRequestQueue;

    private static MSDApplication sInstance;
    ...
    public static synchronized MSDApplication getInstance() {
        return sInstance;
    }
